...
public class Forklift extends Subsystem
{
	...
	static boolean firstTimeInMethod = true;
...
//		positionPID.disable();
	...
	{
//		SmartDashboard.putNumber("New PID Mode", mode);
//		SmartDashboard.putNumber("New PID Setpoint", setPoint);

//		System.out.println("In setPIDmodeAndSetpoint");
//		System.out.println("Position PID enabled");
//		System.out.println(positionPID.isEnable());
//		System.out.println("Velocity PID enabled");
//		System.out.println(velocityPID.isEnable());

//		if (firstTimeInMethod == true)
//		{
//			// only disable both PIDs the first time in the routine
//			firstTimeInMethod = false;
//			
//			// disable the PIDs due to issue with both PIDs being enabled
//			velocityPID.disable();
//			positionPID.disable();
//		}
