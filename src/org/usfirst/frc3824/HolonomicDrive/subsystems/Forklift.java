...
public class Forklift extends PIDSubsystem {
    ...
    PIDController pIDForkliftController = RobotMap.forkliftPIDForkliftController;
    DigitalInput bottomSwitch = RobotMap.forkliftBottomSwitch;
    DigitalInput topSwitch = RobotMap.forkliftTopSwitch;
    ...
    public Forklift() {
        ...
        LiveWindow.addActuator("Forklift", "PIDSubsystem Controller", getPIDController());
