...
public class RobotMap
{
	...
	public static void init()
	{
    	...
    	driveTrainHolonomicDrive.setWheelbase(24, 24);	// setting the wheelbase, units don't matter as long as they are consistent
    	driveTrainHolonomicDrive.setRotationOffset(20, 0);	// put rotation point 20" in front of the robot center point
