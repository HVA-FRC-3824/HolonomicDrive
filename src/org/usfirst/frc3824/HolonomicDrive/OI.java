...
public class OI
{
	...
	public OI()
	{
        ...
        toteCaptureOff = new JoystickButton(forkliftJoystick, 4);
        ...
        forkliftJogDown.whileHeld(new ForkliftMoveContinuous());
        forkliftJogUp = new JoystickButton(forkliftJoystick, 5);
        forkliftJogUp.whenPressed(new ForkliftMoveContinuous());
        ...
        SmartDashboard.putData("Autonomous Get Container To Autozone", new AutonomousGetContainerToAutozone());

        SmartDashboard.putData("Autonomous Stack Container and Tote", new AutonomousStackContainerandTote());

        SmartDashboard.putData("Autonomous Stack Two Tote Container", new AutonomousStackTwoToteContainer());

        SmartDashboard.putData("Autonomous Stack Three Tote Container", new AutonomousStackThreeToteContainer());

        SmartDashboard.putData("Forklift Move Continuous", new ForkliftMoveContinuous());
