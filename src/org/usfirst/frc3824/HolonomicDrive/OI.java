...
public class OI
{
	...
	public JoystickButton ContainerGrip;
	public JoystickButton ContainerRelease;

	public JoystickButton speedOverride;
	public JoystickButton speedOverrideHigh;
	...
	public OI()
	{
        ...
        toteLoadHeight = new JoystickButton(forkliftJoystick, 12);
        toteLoadHeight.whenPressed(new ForkliftMoveToPosition());
        step = new JoystickButton(forkliftJoystick, 4);
        ...
        SmartDashboard.putData("Container Grip", new ContainerGrip());

        SmartDashboard.putData("Container Release", new ContainerRelease());


    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

		// switch 16/17 - unassigned
		// input 20 - unused

		// rollerIn = new JoystickButton(forkliftJoystick, 18);
		// rollerIn.whenPressed(new RollerIn());
		// rollerIn = new JoystickButton(forkliftJoystick, 18);
		// rollerIn.whenReleased(new RollerOff());
		//
		// rollerOut = new JoystickButton(forkliftJoystick, 19);
		// rollerOut.whenPressed(new RollerOut());
		// rollerOut = new JoystickButton(forkliftJoystick, 19);
		// rollerOut.whenReleased(new RollerOff());

		ContainerGrip = new JoystickButton(forkliftJoystick, 18);
		ContainerGrip.whenPressed(new ContainerGrip());

		ContainerRelease = new JoystickButton(forkliftJoystick, 19);
		ContainerRelease.whenPressed(new ContainerRelease());

		speedOverride = new JoystickButton(forkliftJoystick, 2);
		speedOverrideHigh = new JoystickButton(forkliftJoystick, 13);
	}
