...
public class OI
{
	...
	public OI()
	{
        ...
        tote5 = new JoystickButton(forkliftJoystick, 6);
        tote5.whenPressed(new ForkliftMoveToPosition());
        tote4 = new JoystickButton(forkliftJoystick, 5);
        tote4.whenPressed(new ForkliftMoveToPosition());
        tote3 = new JoystickButton(forkliftJoystick, 4);
        tote3.whenPressed(new ForkliftMoveToPosition());
        tote2 = new JoystickButton(forkliftJoystick, 3);
        tote2.whenPressed(new ForkliftMoveToPosition());
        tote1 = new JoystickButton(forkliftJoystick, 2);
        ...
        SmartDashboard.putData("TestOffsetRotation", new TestOffsetRotation());
