...
public class OI
{
	...
	public OI()
	{
        ...
        retract = new JoystickButton(joystick, 1);
        retract.whenReleased(new StabilizerRetract());
        deploy = new JoystickButton(joystick, 1);
        deploy.whenPressed(new StabilizerDeploy());
        ...
        SmartDashboard.putData("Autonomous Get Ready For Litter", new AutonomousGetReadyForLitter());
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        stabilizer = new JoystickButton(forkliftJoystick, 20);
        stabilizer.whenPressed(new StabilizerDeploy());
        stabilizer.whenReleased(new StabilizerRetract());
	}
