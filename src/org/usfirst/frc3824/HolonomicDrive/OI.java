...
public class OI
{
	...
	public OI()
	{
        ...
        SmartDashboard.putData("Autonomous Drag Tote Right", new AutonomousDragToteRight());

        SmartDashboard.putData("Autonomous Drag Tote Left", new AutonomousDragToteLeft());
