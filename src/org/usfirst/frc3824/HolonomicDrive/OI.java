...
public class OI
{
    ...
    public JoystickButton wheelsOff;
	...
	public OI()
	{
        ...
        wheelsOut.whenPressed(new WheelsControl());
        ...
        SmartDashboard.putData("Wheels Control", new WheelsControl());

        SmartDashboard.putData("Set Capture Arm Offsets", new SetCaptureArmOffsets());
