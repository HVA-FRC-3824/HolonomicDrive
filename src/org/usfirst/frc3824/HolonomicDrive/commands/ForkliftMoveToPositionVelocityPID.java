 ...
 * a position PID.
 */
public class ForkliftMoveToPositionVelocityPID extends Command
{
	double position = 0.0;

	public ForkliftMoveToPositionVelocityPID()
	{
	...
	public ForkliftMoveToPositionVelocityPID(double position)
	{
