...
public class ChassisTurnAngle extends Command
{
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=REQUIRES
		...
		// indicate that the turn angle was passed to the class through the constructor
		anglePassed = true;
	}
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=REQUIRES
		...
		// indicate that the turn angle was not passed to the class through the constructor
		anglePassed = false;
	}
