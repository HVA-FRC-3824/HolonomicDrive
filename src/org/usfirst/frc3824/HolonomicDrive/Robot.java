...
public class Robot extends IterativeRobot
{
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
		...
		chooser.addObject("8) Remove Container For 3 Stack",                  new AutonomousRemoveContainer());
        chooser.addObject("9) Stack Two Totes Container",                     new AutonomousStackTwoTotesContainer());
        chooser.addObject("10) Move Container and Ready to Load",             new AutonomousMoveContainerAndAlignToLoad());
